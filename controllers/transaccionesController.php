    ...
    public function agregar(){
        if ($_POST){
            ...
            if ($transacciones->guardar($_POST)){
                $this->_messages->success('Transacción guardada ', $this->redirect(array("controller"=>"transacciones"))
                );
            }
        }
    ...
    public function editar($id=null){
        if ($_POST){
            ...
            if ($transaccion->actualizar($_POST)){
                $this->_messages->success('Datos guardados ', $this->redirect(array("controller"=>"transacciones")));
            }else{
