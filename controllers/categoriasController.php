  ...
  public function agregar(){
        if ($_POST){
            ...
            if ($categorias->guardar($_POST)){
                $this->_messages->success('Guardada ', $this->redirect(array("controller"=>"categorias"))
                );
            }
        }
    ...
    public function editar($id=null){
        if ($_POST){
            ...
            if ($categorias->actualizar($_POST)){
                $this->_messages->success('Guardados ', $this->redirect(array("controller"=>"categorias")));
            }else{
    ...
    public function eliminar($id){
        ...
        if (!empty($registro)){
            ...
            $this->_messages->success('Eliminada correctamente', $this->redirect(array("controller"=>"categorias")));
        }
    }
}
