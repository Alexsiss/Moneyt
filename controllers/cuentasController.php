...
class cuentasController extends AppController
{
    ...
    public function agregar(){
        if ($_POST){
            ...
            if ($cuentas->guardar($_POST)){
                $this->_messages->success('Guardada correctamente', $this->redirect(array("controller"=>"cuentas"))
                );
            }
        }
    ...
    public function editar($id=null){
        if ($_POST){
            ...
            if ($cuentas->actualizar($_POST)){
                $this->_messages->success('Guardado correctamente', $this->redirect(array("controller"=>"cuentas")));
            }else{
    ...
    public function eliminar($id){
        ...
        if (!empty($registro)){
            ...
            $this->_messages->success('Eliminada correctamente', $this->redirect(array("controller"=>"cuentas")));
        }
    }
}